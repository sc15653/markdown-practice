...
**What Makes Jollof Special? You make ask**

Jollof rice is made by simmering long grain rice in a blended mixture of tomatoes, peppers, onions, spices and stock. The flavor develops slowly and every spoonful tastes smoky, spicy and deeply savory. Not only this, it is the first dish my mum taught me to make. Till this day i still teach my friends and siblings how to prepare it exactly like her.
...
- Fresh tomatoes and red bell peppers
...
**Steps I Follow When Cooking Jollof**

1. Blend tomatoes, bell peppers, scotch bonnet and onions.

2. Rinse the rice to remove excess starch.

3. Heat oil and add the tomato mixture with spices.

4. Add the rice and stock, then cover the pot.
...
```python
def cook_jollof(rice):
    if rice == "parboiled":
        return "Simmer with blended stew until fluffy"
    else:
        return "Adjust water and watch the texture closely"
```

 **Jollof Variations I Have Tried** 
| Version    | Description       | 
|----------------|-----------------------|
...
[^jollof]: Whether it is a celebration or a simple dinner, a good pot of Nigerian jollof rice always makes the moment feel special.
